 ...
 */
@WebServlet("/controller/myProcessGetCurrentActivityController")
public class MyProcessGetCurrentActivityController extends HttpServlet {
	private static final long serialVersionUID = 4L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyProcessGetCurrentActivityController() {
        super();
