 ...
 */
@WebServlet("/controller/redProcessGetCurrentActivityController")
public class RedProcessGetCurrentActivityController extends HttpServlet {
	private static final long serialVersionUID = 4L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RedProcessGetCurrentActivityController() {
        super();
